...
Промо-ролик главной (живой прод, один бесшовный цикл 42 с, звуковые эффекты): [docs/video/preview.mp4](docs/video/preview.mp4) · Полный видео-тур по продукту: [docs/video/tour.mp4](docs/video/tour.mp4) · Скриншот главной: [home-desktop.png](docs/screenshots/home-desktop.png)

## Возможности

- **Живая сцена в герое** — процедурный low-poly Заилийский Алатау (fBm-рельеф, сетка треугольников с фасетной подсветкой, снежники), смог плотнеет с ростом AQI и гасит огни города, облака и осадки по текущей погоде Open-Meteo, рядом виджет температуры. Только CSS-transform на композитных слоях: без rAF и canvas, пауза вне экрана, reduced-motion уважается
...
| Погода | [Open-Meteo](https://open-meteo.com) Forecast (центр города) | Температура, код WMO, ветер, день/ночь — для виджета и сцены в герое |
...
- **Vitest** — 387 юнит-тестов (шкала AQI, геопривязка, нормализация источников, история, push, сборщик, процедурный рельеф и смог сцены, коды погоды)
